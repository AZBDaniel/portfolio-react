        ...
        <div>
            ...
            <section id="work">
                ...
                <div className="section-content box-column">
                    <a href="https://azbdaniel.github.io/run-buddy/" className="tile large-tile box-row">
                        {/*Image Info Tag*/}
                        <div className="tile-tag">
                            <p className="tile-title">Run Buddy</p>
                            <p className="tile-info">HTML/CSS/JS</p>
                        </div>
                    </a>
                    {/*Small tiles sections below*/}
                    <div className="box-row">
                        <a href="https://azbdaniel.github.io/horiseon-site/" className="tile small-tile t1 box-row">
                            {/*Image Info Tag*/}
                            <div className="tile-tag">
                                <p className="tile-title">Horiseon</p>
                                <p className="tile-info">HTML/CSS</p>
                            </div>
                        </a>
                        <a href="https://azbdaniel.github.io/hot-spot/" className="tile small-tile t2 box-row">
                            <div className="tile-tag">
                                ...
                                <p className="tile-info">HTML, JS, CSS, Bulma, Google API, Weather API ?</p>
                            </div>
                        </a>
                    </div>
                    <div className="box-row">
                        <a href="https://github.com/AZBDaniel/mustache_cars" className="tile small-tile t3 box-row">
                            {/*Image Info Tag*/}
                            <div className="tile-tag">
                        ...
                        <a href className="tile small-tile t4 box-row">
                            {/*Image Info Tag*/}
                            <div className="tile-tag">
